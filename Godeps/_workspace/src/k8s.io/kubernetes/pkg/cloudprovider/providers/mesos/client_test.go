...
const (
	...
	TEST_STATE_JSON = `
	{
		...
		"slaves": [
		{
			...
			"pid": "slave(1)@mesos1.internal.company.com.fail:5050",
			"id": "20150419-081501-16777343-5050-16383-S2",
			"hostname": "mesos1.internal.company.com.fail",
			"attributes": {},
			"active": true
		},
		{
			...
			"pid": "slave(1)@mesos2.internal.company.com.fail:5050",
			"id": "20150419-081501-16777343-5050-16383-S1",
			"hostname": "mesos2.internal.company.com.fail",
			"attributes": {},
			"active": true
		},
		{
			...
			"pid": "slave(1)@mesos3.internal.company.com.fail:5050",
			"id": "20150419-081501-16777343-5050-16383-S0",
			"hostname": "mesos3.internal.company.com.fail",
			"attributes": {},
			"active": true
		}
		],
		"pid": "master@mesos-master0.internal.company.com.fail:5050",
		"orphan_tasks": [],
		"lost_tasks": 0,
		"leader": "master@mesos-master0.internal.company.com.fail:5050",
		"killed_tasks": 0,
		"failed_tasks": 0,
...
func Test_listSlaves(t *testing.T) {
	...
	expectedHostnames := map[string]struct{}{
		"mesos1.internal.company.com.fail": {},
		"mesos2.internal.company.com.fail": {},
		"mesos3.internal.company.com.fail": {},
	}
