...
sed -i "s|@@PACKAGE_LIST-VARIABLE@@|docker*1.9* docker*1.10* docker*1.11* docker*1.12* docker*1.13* docker*1.14* docker*1.15* docker*1.16* docker*1.17* docker*1.18* docker*1.19* docker*1.20*|" $RPM_BUILD_ROOT/usr/sbin/%{name}-docker-excluder
