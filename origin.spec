...
%{!?commit:
%global commit c5b0abf8bfaade1731f79189d51d3daed87ad018
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.41 OS_GIT_COMMIT=c5b0abf OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
