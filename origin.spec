...
%{!?commit:
%global commit 090a815a8df037bde8783ee809f5c5b13c1a25dc
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.31 OS_GIT_COMMIT=090a815 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
