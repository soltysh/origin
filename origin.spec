...
%{!?commit:
%global commit 7bd9deaa605824f265459ceab7555b5fec05aee6
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.26 OS_GIT_COMMIT=7bd9dea OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
