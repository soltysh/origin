...
%{!?commit:
%global commit d5e39ac08db9a6768ac1fff1e02539678b2e3edc
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.35 OS_GIT_COMMIT=d5e39ac OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
