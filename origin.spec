...
%{!?commit:
%global commit af55f0e896dff753becf494dadad33e00bb09baf
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.43 OS_GIT_COMMIT=af55f0e OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
