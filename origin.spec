...
%{!?commit:
%global commit ee4ed8735d2e70a73078fd4a476f4253d86d62d6
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.49 OS_GIT_COMMIT=a32d1bd OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
