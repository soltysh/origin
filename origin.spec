...
%{!?commit:
%global commit fe4f89a6f1d0467e18e908f79c174e7aa63134d9
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.44 OS_GIT_COMMIT=fe4f89a OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
