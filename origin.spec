...
%{!?commit:
%global commit a844768adcb19a863ee75c00f268094c0644964d
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.56 OS_GIT_COMMIT=a844768adc OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
