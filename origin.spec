...
%{!?commit:
%global commit ceecb8581c79acd487c56b72a02fb85f95c3aea2
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.48 OS_GIT_COMMIT=ceecb85 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
