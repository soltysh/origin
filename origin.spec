...
%{!?commit:
%global commit 99c7fdab719c25daf35ff620aaadf53c7f61459a
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.36 OS_GIT_COMMIT=99c7fda OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
