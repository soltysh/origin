...
%{!?commit:
%global commit d7eb02895334cf38a944decdc4836baacbb51ae0
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.53 OS_GIT_COMMIT=d7eb028 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
