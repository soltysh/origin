...
%{!?commit:
%global commit 5fb659366b8f29b8ea3a8ecaa48c2bfd3573bcb9
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.25 OS_GIT_COMMIT=5fb6593 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
