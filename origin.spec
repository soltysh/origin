...
%{!?commit:
%global commit 895a3315830cbbe14bf607ac0573933784a46d28
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.27 OS_GIT_COMMIT=895a331 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
