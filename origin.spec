...
%{!?commit:
%global commit b42d26cacc476716976e13b91dbe3cee76510459
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.17 OS_GIT_COMMIT=b42d26c OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
