...
%{!?commit:
%global commit 22f116574ce86b7c74b64b16e87d99c888677944
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_MINOR=6+ OS_GIT_MAJOR=3 OS_GIT_VERSION=v3.6.126.14 OS_GIT_TREE_STATE=clean OS_BUILD_LDFLAGS_DEFAULT_IMAGE_STREAMS=rhel7 OS_IMAGE_PREFIX=registry.access.redhat.com/openshift3/ose OS_GIT_COMMIT=22f1165
}
...
- Bumping version to sync with openshift-ansible (jupierce@redhat.com)
...
- Bump version to catch openshift-ansible (jupierce@redhat.com)

* Thu Jul 06 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.126.9-1
- Merge remote-tracking branch stage, bump origin-web-console 066938a
  (smunilla@redhat.com)
...
* Fri Jun 30 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.126.5-1
- Merge remote-tracking branch stage, bump origin-web-console 8e1222f
  (smunilla@redhat.com)

* Thu Jun 29 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.126.4-1
- Merge remote-tracking branch stage, bump origin-web-console c982d21
  (smunilla@redhat.com)
