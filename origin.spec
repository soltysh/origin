...
%{!?commit:
%global commit a469e3d483d128a98b655286e69f675c080118c4
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.16 OS_GIT_COMMIT=a469e3d OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
