...
%{!?commit:
%global commit 5d06035b163158758aacf8305503de71c5b51c0c
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_MINOR=6+ OS_GIT_MAJOR=3 OS_GIT_VERSION=v3.6.173.0.173 OS_GIT_TREE_STATE=clean OS_BUILD_LDFLAGS_DEFAULT_IMAGE_STREAMS=rhel7 OS_IMAGE_PREFIX=registry.access.redhat.com/openshift3/ose OS_GIT_COMMIT=5d06035b16
}
...
%changelog
* Sun Jul 14 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.174-1
- 

* Sun Jul 07 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.173-1
- 

* Sun Jun 30 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.172-1
- 

* Sun Jun 23 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.171-1
- 

* Sun Jun 16 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.170-1
- 

* Sun Jun 09 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.169-1
- 

* Sun Jun 02 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.168-1
- 

* Sun May 26 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.167-1
- 

* Sun May 19 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.166-1
- 

* Sun May 12 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.165-1
- 
...
* Sun Feb 24 2019 AOS Automation Release Team <aos-team-art@redhat.com> 3.6.173.0.152-1
- 
...
- [3.6] bump(github.com/evanphx/json-patch):
...
- handle non-generic output - oc export (jvallejo@redhat.com)
- UPSTREAM: 46265: fallback GetGenericPrinter to HumanReadablePrinter
  (jvallejo@redhat.com)
...
* Fri Mar 16 2018 Justin Pierce <jupierce@redhat.com> 3.6.173.0.108-1
- 

* Fri Mar 16 2018 Justin Pierce <jupierce@redhat.com> 3.6.173.0.107-1
- 
...
- Merge remote-tracking branch enterprise-3.6, bump origin-web-console d14c1e4
  (jupierce@redhat.com)
- UPSTREAM: 57484: Fix a bug in validating node existence (mfojtik@redhat.com)
...
- Migrate: handle NotFound via resource matching and during conflicts
  (mkhan@redhat.com)
- Fix issues with oc adm migrate authorization (mkhan@redhat.com)
...
- Merge remote-tracking branch enterprise-3.6, bump origin-web-console f610085
  (smunilla@redhat.com)
...
- fixups after source-to-image bump (jminter@redhat.com)
- bump(github.com/openshift/source-to-image):
  582577d4405451cc83a71b6a2aea5e1682c8ea50 (jminter@redhat.com)
...
- tests: fix TestSandboxStatusAfterRestart after 684b93e (dcbw@redhat.com)
...
- UPSTREAM: 46823: kubelet/network: report but tolerate errors returned from
  GetNetNS() v2 (dcbw@redhat.com)

* Tue Dec 05 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.173.0.84-1
- sdn: fix locking of egress DNS policy updates (dcbw@redhat.com)
...
- fixup to bz1519296 (jminter@redhat.com)
...
* Fri Nov 24 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.173.0.80-1
- 

* Wed Nov 22 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.173.0.79-1
- Allow assign-macvlan annotation to specify an interface (danw@redhat.com)
- Fix upgrade failure and/or crash on invalid CIDR values in master-config
  (danw@redhat.com)
...
- UPSTREAM: opencontainers/runc: 1651: systemd: adjust CPUQuotaPerSecUSec to
  compensate for systemd internal handling (sjenning@redhat.com)
...
* Mon Nov 06 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.173.0.67-1
- 

* Mon Nov 06 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.173.0.66-1
- 
...
- UPSTREAM: 50381: Bugfix: Use local JSON log buffer in parseDockerJSONLog
  (sjenning@redhat.com)
- UPSTREAM: 44868: Adding datastore cluster support for dynamic and static pv
  (ppospisi@redhat.com)
- UPSTREAM: 42974: VSAN policy support for storage volume provisioning inside
  kubernetes (ppospisi@redhat.com)
...
- [3.6] sdn: only sync HostPorts when we need to (backport) (dcbw@redhat.com)
...
- UPSTREAM: 53682: Fix lock usage in desired_state_of_world
  (hekumar@redhat.com)
...
* Wed Sep 27 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.173.0.42-1
...
- hack in field selectors for 3.6 (deads@redhat.com)
...
- UPSTREAM: 52221: fix detach delay (hekumar@redhat.com)

* Mon Sep 18 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.173.0.36-1
- Backport UPSTREAM: 45352: Pod (Anti)affinity shouldn't be respected across
  namespaces. (ravisantoshgudimetla@gmail.com)
...
- UPSTREAM: 45352: Pod (Anti)affinity shouldn't be respected across namespaces.
  (ravisantoshgudimetla@gmail.com)
- Disable RBAC create commands (ffranz@redhat.com)
...
- Merge remote-tracking branch enterprise-3.6, bump origin-web-console 9fc9e53
  (smunilla@redhat.com)
...
- Merge remote-tracking branch enterprise-3.6, bump origin-web-console a535e0d
  (smunilla@redhat.com)
...
- Enable ScaleIO volume plugin. (ppospisi@redhat.com)
...
- bump(github.com/openshift/source-to-image):
  8d33dfc3aca1004b68644e4fac8332a0317cfb93 (bparees@redhat.com)
...
- specfile cleanup (jolamb@redhat.com)
...
- Merge remote-tracking branch enterprise-3.6, bump origin-web-console 7873511
  (smunilla@redhat.com)
...
- backporting to 3.6 (cdaley@redhat.com)
...
- Merge remote-tracking branch enterprise-3.6, bump origin-web-console f0bf798
  (smunilla@redhat.com)

* Fri Jul 21 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.165-1
- 

* Fri Jul 21 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.6.164-1
...
- Reconcile controller roles at startup (jliggitt@redhat.com)
