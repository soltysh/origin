...
%{!?commit:
%global commit 2497c3428be0babd0ea671d02d44a7e5e0128205
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.42 OS_GIT_COMMIT=2497c34 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
