...
%{!?commit:
%global commit c355efc8ba450646a2fe6e775f3f724b9de85249
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_MINOR=10+ OS_GIT_MAJOR=3 OS_GIT_VERSION=v3.10.85 OS_GIT_TREE_STATE=clean OS_BUILD_LDFLAGS_DEFAULT_IMAGE_STREAMS=rhel7 KUBE_GIT_VERSION=v1.10.0+b81c8f8 OS_GIT_PATCH=85 KUBE_GIT_COMMIT=b81c8f8 KUBE_GIT_MINOR=10+ OS_GIT_COMMIT=99d0fa2fc7 KUBE_GIT_MAJOR=1 OS_IMAGE_PREFIX=registry.access.redhat.com/openshift3/ose ETCD_GIT_VERSION=v3.2.16-0-g121edf0 ETCD_GIT_COMMIT=121edf0
}
...
- UPSTREAM: 70291: don't delete vsphere node on shutdown (hekumar@redhat.com)
...
- approvers: Add Ben Bennett as a reviewer for backports (ccoleman@redhat.com)
...
- patch up e2e tests to use version-aligned templates (bparees@redhat.com)
- bump(*) (bparees@redhat.com)

* Wed Oct 31 2018 AOS Automation Release Team <aos-team-art@redhat.com> 3.10.68-1
- UPSTREAM: <drop>: Fix compilation error (jsafrane@redhat.com)
...
- Bug 1632154 - Accept logFormat when passed to audit config
  (maszulik@redhat.com)
...
- [3.10] bump(github.com/evanphx/json-patch):
