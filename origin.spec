...
%{!?commit:
%global commit e26af189d966b8ef54d8e8fe1eb2d5c6267a9836
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.28 OS_GIT_COMMIT=e26af18 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
