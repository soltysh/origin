...
%{!?commit:
%global commit 802842bbbcf503c5c2293a5236153743eaf3b946
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_MINOR=6+ OS_GIT_MAJOR=3 OS_GIT_VERSION=v3.6.78 OS_GIT_TREE_STATE=clean OS_BUILD_LDFLAGS_DEFAULT_IMAGE_STREAMS=rhel7 OS_IMAGE_PREFIX=registry.access.redhat.com/openshift3/ose OS_GIT_COMMIT=802842b
}
...
* Wed May 17 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.6.77-1
- 

* Tue May 16 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.6.76-1
- Merge remote-tracking branch stage, bump origin-web-console 272d713
  (tdawson@redhat.com)
- Change Version to synchronize with master builds (jupierce@redhat.com)
...
* Tue May 09 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.6.74-1
- 
