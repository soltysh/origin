...
%{!?commit:
%global commit 5a499e36405531bc041c0059e5664ed5a42c11cd
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_MINOR=3+ OS_GIT_MAJOR=4 OS_GIT_VERSION=v4.3.0 OS_GIT_TREE_STATE=clean OS_BUILD_LDFLAGS_DEFAULT_IMAGE_STREAMS=rhel7 KUBE_GIT_VERSION=v1.16.0-beta.2+5a499e364 OS_GIT_PATCH=0 KUBE_GIT_COMMIT=2f054b7 KUBE_GIT_MINOR=16+ OS_GIT_COMMIT=5a499e364 KUBE_GIT_MAJOR=1 OS_IMAGE_PREFIX=registry.redhat.io/openshift3/ose ETCD_GIT_VERSION=v3.3.10 ETCD_GIT_COMMIT=27fc7e2
}
