...
%{!?commit:
%global commit d4f51417156c46bc5f6f7478e4478326c1987475
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_MINOR=7+ OS_GIT_MAJOR=3 OS_GIT_VERSION=v3.7.120 OS_GIT_TREE_STATE=clean OS_BUILD_LDFLAGS_DEFAULT_IMAGE_STREAMS=rhel7 OS_GIT_CATALOG_VERSION=v0.1.2 OS_IMAGE_PREFIX=registry.access.redhat.com/openshift3/ose OS_GIT_COMMIT=ae12c81ad6
}
...
- Update egress-router script for connect-to-node-IP changes (danw@redhat.com)
...
- Fix bug 1278683 for 3.7 (lxia@redhat.com)
...
- Fix bad backport (danw@redhat.com)
...
- Set up node/service routes in egress routers (for DNS) (danw@redhat.com)
...
- endpoints/handlers/proxy: fix upgrade error handling
...
* Thu Oct 11 2018 AOS Automation Release Team <aos-team-art@redhat.com> 3.7.67-1
- 

* Wed Oct 10 2018 AOS Automation Release Team <aos-team-art@redhat.com> 3.7.66-1
- 
...
- UPSTREAM: 60978: Fix use of "-w" flag to iptables-restore
  (jtanenba@redhat.com)
- [3.7] bump(github.com/evanphx/json-patch):
...
* Mon Jul 09 2018 Tim Bielawa <tbielawa@redhat.com> 3.7.57-1
- Fix a crash on a certain type of unsupported NetworkPolicy (danw@redhat.com)

* Thu Jun 28 2018 Tim Bielawa <tbielawa@redhat.com> 3.7.56-1
...
* Mon Jun 18 2018 Tim Bielawa <tbielawa@redhat.com> 3.7.55-1
- 
...
- UPSTREAM: docker/distribution: 2605: s3: Add eu-west-3 region
  (agladkov@redhat.com)
- [3.7] s2i Check Assemble User Against Allowed UIDs (adam.kaplan@redhat.com)
...
- Automatic commit of package [atomic-openshift] release [3.7.43-1] ; bump
  origin-web-console 912ff65 (jupierce@redhat.com)
...
- UPSTREAM: 48936: AWS: check validity of KSM key before creating a new
  encrypted disk (jsafrane@redhat.com)
...
- UPSTREAM: 57422: Rework method of updating atomic-updated data volumes
  (joesmith@redhat.com)
- UPSTREAM: xyz: Lock subPath volumes (jsafrane@redhat.com)
...
- Automatic commit of package [atomic-openshift] release [3.7.34-1] ; bump
  origin-web-console f5a7248 (jupierce@redhat.com)
...
* Fri Feb 16 2018 Justin Pierce <jupierce@redhat.com> 3.7.30-1
- Automatic commit of package [atomic-openshift] release [3.7.30-1] ; bump
  origin-web-console c3c68b6 (jupierce@redhat.com)
- [3.7] UPSTREAM: 52046: [BugFix] Soft Eviction timer works correctly
  (ravisantoshgudimetla@gmail.com)
- UPSTREAM: 55631: Parse and return the last line in the log even if it is
  partial (runcom@redhat.com)
- [BACKPORT] setup selinux labels for build containers (bparees@redhat.com)
...
- Automatic commit of package [atomic-openshift] release [3.7.26-1] ; bump origin-web-console ae9ff57

* Mon Jan 22 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.25-1
- Automatic commit of package [atomic-openshift] release [3.7.25-1] ; bump origin-web-console 4db6610

* Fri Jan 19 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.24-1
- Automatic commit of package [atomic-openshift] release [3.7.24-1] ; bump origin-web-console 4db6610

* Thu Jan 11 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.23-1
- Automatic commit of package [atomic-openshift] release [3.7.23-1] ; bump origin-web-console b59a3ee

* Mon Jan 08 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.22-1
- Automatic commit of package [atomic-openshift] release [3.7.22-1] ; bump origin-web-console b59a3ee

* Mon Jan 08 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.21-1
- Automatic commit of package [atomic-openshift] release [3.7.21-1] ; bump origin-web-console e412660

* Fri Jan 05 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.20-1
- Automatic commit of package [atomic-openshift] release [3.7.20-1] ; bump origin-web-console e412660

* Thu Jan 04 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.19-1
- Automatic commit of package [atomic-openshift] release [3.7.19-1] ; bump origin-web-console e412660

* Thu Jan 04 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.18-1
- Automatic commit of package [atomic-openshift] release [3.7.18-1] ; bump origin-web-console e412660

* Mon Jan 01 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.17-1
- Automatic commit of package [atomic-openshift] release [3.7.17-1] ; bump origin-web-console e412660

* Thu Dec 21 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.16-1
- Automatic commit of package [atomic-openshift] release [3.7.16-1]; bump origin-web-console e412660

* Fri Dec 08 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.15-1
- Automatic commit of package [atomic-openshift] release [3.7.15-1]; bump origin-web-console 0c5eae8

* Wed Dec 06 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.14-1
- Automatic commit of package [atomic-openshift] release [3.7.14-1]; bump origin-web-console 

* Tue Dec 05 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.13-1
- Automatic commit of package [atomic-openshift] release [3.7.13-1]; bump origin-web-console 

* Mon Dec 04 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.12-1
- Automatic commit of package [atomic-openshift] release [3.7.12-1]; bump origin-web-console 

* Fri Dec 01 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.11-1
- Automatic commit of package [atomic-openshift] release [3.7.11-1]; bump origin-web-console 

* Fri Dec 01 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.7.10-1
- Automatic commit of package [atomic-openshift] release [3.7.10-1]; bump origin-web-console 
