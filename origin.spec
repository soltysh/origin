...
%{!?commit:
%global commit 1cdd0f11c2c8da76cabf28f7ce3a06f8ed7c7673
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.11 OS_GIT_COMMIT=1cdd0f1 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
