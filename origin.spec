...
%{!?commit:
%global commit 0b0fcab4aaa124c2c3802e99920c3450959d13e8
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.38 OS_GIT_COMMIT=0b0fcab OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
