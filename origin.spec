...
%{!?commit:
%global commit 584624401ece9d2c8303a5f523375ae6c8b5e5ce
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.22 OS_GIT_COMMIT=5846244 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
