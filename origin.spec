...
%{!?commit:
%global commit fc18ad8f7af6456bee68f67df1c207972fce8eee
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.40 OS_GIT_COMMIT=fc18ad8 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
