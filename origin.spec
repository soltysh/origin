...
%{!?commit:
%global commit 51199de57b2cdffbb74285d2fdaaa1e2b8fb737f
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.3.1.46.44 OS_GIT_COMMIT=51199de57b OS_GIT_MAJOR=3 OS_GIT_MINOR=3+
}
...
sed -i "s|@@PACKAGE_LIST-VARIABLE@@|docker*1.12* docker*1.13* docker*1.14* docker*1.15* docker*1.16* docker*1.17* docker*1.18* docker*1.19* docker*1.20*|" $RPM_BUILD_ROOT/usr/sbin/%{name}-docker-excluder
...
%changelog
* Fri Nov 16 2018 AOS Automation Release Team <aos-team-art@redhat.com> 3.3.1.46.45
- 

* Fri Nov 16 2018 AOS Automation Release Team <aos-team-art@redhat.com> 3.3.1.46.44
...
- [3.3] bump(github.com/evanphx/json-patch):
...
- Use 3.4 tito/lib configuration (smunilla@redhat.com)
...
* Wed May 09 2018 Justin Pierce <jupierce@redhat.com> 3.3.1.46.41
- 

* Tue May 08 2018 Justin Pierce <jupierce@redhat.com> 3.3.1.46.40
- Merge remote-tracking branch enterprise-3.3, bump origin-web-console 5d942e4
  (jupierce@redhat.com)
...
* Thu Jan 25 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.37
- Dockerfile reconcile cleanup (adammhaile@gmail.com)

* Tue Jan 23 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.36
- 

* Tue Jan 23 2018 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.35
- Merge remote-tracking branch enterprise-3.3, bump origin-web-console edf6b62
  (smunilla@redhat.com)

* Fri Nov 10 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.34
- 

* Tue Nov 07 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.33
- 

* Thu Nov 02 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.32
- 

* Tue Oct 31 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.31
- 

* Thu Oct 26 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.30
- 

* Tue Oct 24 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.29
- 

* Thu Oct 19 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.28
- 

* Tue Oct 17 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.27
- 

* Thu Oct 12 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.26
- 
...
* Tue Oct 03 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.23
- 

* Thu Sep 28 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.22
- 

* Tue Sep 26 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.21
- UPSTREAM: google/cadvisor: 1700: Reduce log spam when unable to get network
  stats (sjenning@redhat.com)

* Tue Sep 26 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.20
- 

* Tue Sep 26 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.19
- Merge remote-tracking branch enterprise-3.3, bump origin-web-console af1dbbd
  (smunilla@redhat.com)

* Tue Sep 05 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.18
- 

* Thu Aug 31 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.17
- UPSTREAM: #25036: api: validate generation updates (tnozicka@gmail.com)
- UPSTREAM: #27269: Graceful deletion bumps object's generation
  (tnozicka@gmail.com)

* Tue Aug 29 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.16
- 

* Wed Aug 23 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.15
- 

* Thu Aug 17 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.14
- 

* Tue Aug 15 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.13
- 

* Thu Aug 10 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.12
- Fix panic when tag is nil when creating istag (maszulik@redhat.com)

* Tue Aug 08 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.11
- 

* Thu Aug 03 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.10
- 

* Tue Aug 01 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.9
- 

* Fri Jul 28 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.8
- 

* Tue Jul 25 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.7
- Merge remote-tracking branch enterprise-3.3, bump origin-web-console af1dbbd
  (smunilla@redhat.com)
...
* Wed Jul 19 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.6
- 

* Fri Jul 14 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.5
- 

* Wed Jul 12 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.4
- [Backport] Support OpenStack+ESXi Volumes in GetDevicePath
  (ppospisi@redhat.com)
- [Backport] Bz #1408867: Backport K8s PR #33270: Don't Rely on Device name
  provided by Cinder (ppospisi@redhat.com)

* Fri Jul 07 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.3
- 

* Wed Jul 05 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.2
- 

* Fri Jun 30 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.1
- 

* Fri Jun 30 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46.0
- 

* Fri Jun 23 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.46
- 

* Thu Jun 22 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.45
- 

* Wed Jun 21 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.44
- Merge remote-tracking branch enterprise-3.3, bump origin-web-console af1dbbd
  (smunilla@redhat.com)

* Fri Jun 16 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.43
- 

* Fri Jun 16 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.42
- 

* Fri Jun 16 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.41
- 

* Fri Jun 16 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.40
- Merge remote-tracking branch enterprise-3.3, bump origin-web-console af1dbbd
  (smunilla@redhat.com)

* Fri Jun 16 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.39
- 

* Wed Jun 14 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.38
- 

* Tue Jun 13 2017 Jenkins CD Merge Bot <smunilla@redhat.com> 3.3.1.37
- 

* Fri Jun 09 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.36
- 

* Wed Jun 07 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.35
- 

* Fri Jun 02 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.34
- 

* Fri Jun 02 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.33
- 

* Thu Jun 01 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.32
- Exclude list cleans up properly (#1430929) (tdawson@redhat.com)
- UPSTREAM: <carry>: Fix remove_all test failures (hekumar@redhat.com)
- UPSTREAM: <carry>: Fix mounter panics (hekumar@redhat.com)
- [Backport from 3.5] Fix for bz1438402 (rchopra@redhat.com)
...
* Thu May 18 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.27
- 

* Tue May 16 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.26
- 
...
* Thu May 04 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.23
- 
...
* Thu Feb 23 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.16
...
* Tue Feb 21 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.3.1.15
...
- Docker 1.12 should be excluded from OCP 3.3 (sdodson@redhat.com)
- UPSTREAM: 30253: fix same node port different protocols conflict issue
  (dhodovsk@redhat.com)
...
- UPSTREAM: 38818: AWS: Add sequential allocator for device names.
  (gethemant@gmail.com)
- UPSTREAM: 31090: AWS: fix volume device assignment race condition
  (hekumar@redhat.com)
...
* Tue Nov 01 2016 Scott Dodson <sdodson@redhat.com> 3.3.1.4
- Remove dependence on external mysql image tag order (jliggitt@redhat.com)
- Fix faulty route ordering (marun@redhat.com)
...
* Wed Oct 05 2016 Scott Dodson <sdodson@redhat.com> 3.3.1.0
- Merge remote-tracking branch upstream/enterprise-3.3, bump origin-web-console
  360cf95 (sdodson@redhat.com)
...
- Update generated files (sttts@redhat.com)
- Adapt TestKubeletDefaults test (sttts@redhat.com)
- UPSTREAM: 27180: Cherry-picked (sttts@redhat.com)
