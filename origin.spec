...
%{!?commit:
%global commit 6719aa21661ab4052f62ede3dc382e03f17a466c
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.1 OS_GIT_COMMIT=6719aa2 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
