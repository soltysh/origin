...
%{!?commit:
%global commit 6d0205c217fc5bad2e9dfccdc089048e0dfecd19
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.8 OS_GIT_COMMIT=6d0205c OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
