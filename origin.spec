...
%{!?commit:
%global commit b98f16189651e5b1ad7136cde93a77818bc65ab1
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.43 OS_GIT_COMMIT=b98f161 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
