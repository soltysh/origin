...
%{!?commit:
%global commit e2b35b41cfce34ab3057e96484feb62d096b9e3a
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.44.15 OS_GIT_COMMIT=e2b35b4 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
