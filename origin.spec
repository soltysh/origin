...
%{!?commit:
%global commit e775fe2dba204ef43a73c9317a7996a8c117fe7e
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.42 OS_GIT_COMMIT=e775fe2 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
