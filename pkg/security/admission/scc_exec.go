...
func (d *sccExecRestrictions) Admit(a admission.Attributes) (err error) {
	...
	createAttributes := admission.NewAttributesRecord(pod, api.Kind("Pod"), a.GetNamespace(), a.GetName(), a.GetResource(), a.GetSubresource(), admission.Create, a.GetUserInfo())
