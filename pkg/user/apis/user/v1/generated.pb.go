...
func (this *Identity) String() string {
	...
	s := strings.Join([]string{`&Identity{`,
		...
		`User:` + strings.Replace(strings.Replace(this.User.String(), "ObjectReference", "github_com_openshift_origin_pkg_authorization_apis_authorization_v1.ObjectReference", 1), `&`, ``, 1) + `,`,
...
func (this *UserIdentityMapping) String() string {
	...
	s := strings.Join([]string{`&UserIdentityMapping{`,
		`ObjectMeta:` + strings.Replace(strings.Replace(this.ObjectMeta.String(), "ObjectMeta", "k8s_io_apimachinery_pkg_apis_meta_v1.ObjectMeta", 1), `&`, ``, 1) + `,`,
		`Identity:` + strings.Replace(strings.Replace(this.Identity.String(), "ObjectReference", "github_com_openshift_origin_pkg_authorization_apis_authorization_v1.ObjectReference", 1), `&`, ``, 1) + `,`,
		`User:` + strings.Replace(strings.Replace(this.User.String(), "ObjectReference", "github_com_openshift_origin_pkg_authorization_apis_authorization_v1.ObjectReference", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
...
var fileDescriptorGenerated = []byte{
	...
	,
}
