...
var map_MasterConfig = map[string]string{
	...
	"deploymentControllerResyncMinutes": "DeploymentControllerResyncMinutes is how often the deployment controllers should perform a full resync of their work queues.",
}
