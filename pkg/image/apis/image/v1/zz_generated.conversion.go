...
func autoConvert_v1_Image_To_image_Image(in *Image, out *image.Image, s conversion.Scope) error {
	...
	if in.Signatures != nil {
		...
		*out = make([]image.ImageSignature, len(*in))
		for i := range *in {
			if err := Convert_v1_ImageSignature_To_image_ImageSignature(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_image_Image_To_v1_Image(in *image.Image, out *Image, s conversion.Scope) error {
	...
	if in.Signatures != nil {
		...
		*out = make([]ImageSignature, len(*in))
		for i := range *in {
			if err := Convert_image_ImageSignature_To_v1_ImageSignature(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1_ImageImportSpec_To_image_ImageImportSpec(in *ImageImportSpec, out *image.ImageImportSpec, s conversion.Scope) error {
	// WARNING: in.From requires manual conversion: inconvertible types (invalid type vs k8s.io/kubernetes/pkg/api.ObjectReference)
	if in.To != nil {
		in, out := &in.To, &out.To
...
func autoConvert_image_ImageImportSpec_To_v1_ImageImportSpec(in *image.ImageImportSpec, out *ImageImportSpec, s conversion.Scope) error {
	// WARNING: in.From requires manual conversion: inconvertible types (k8s.io/kubernetes/pkg/api.ObjectReference vs invalid type)
	if in.To != nil {
		in, out := &in.To, &out.To
...
func autoConvert_v1_ImageSignature_To_image_ImageSignature(in *ImageSignature, out *image.ImageSignature, s conversion.Scope) error {
	...
	if in.Conditions != nil {
		...
		*out = make([]image.SignatureCondition, len(*in))
		for i := range *in {
			if err := Convert_v1_SignatureCondition_To_image_SignatureCondition(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_image_ImageSignature_To_v1_ImageSignature(in *image.ImageSignature, out *ImageSignature, s conversion.Scope) error {
	...
	if in.Conditions != nil {
		...
		*out = make([]SignatureCondition, len(*in))
		for i := range *in {
			if err := Convert_image_SignatureCondition_To_v1_SignatureCondition(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1_ImageStreamTag_To_image_ImageStreamTag(in *ImageStreamTag, out *image.ImageStreamTag, s conversion.Scope) error {
	...
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]image.TagEventCondition, len(*in))
		for i := range *in {
			if err := Convert_v1_TagEventCondition_To_image_TagEventCondition(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_image_ImageStreamTag_To_v1_ImageStreamTag(in *image.ImageStreamTag, out *ImageStreamTag, s conversion.Scope) error {
	...
	if in.Conditions != nil {
		...
		*out = make([]TagEventCondition, len(*in))
		for i := range *in {
			if err := Convert_image_TagEventCondition_To_v1_TagEventCondition(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1_SignatureCondition_To_image_SignatureCondition(in *SignatureCondition, out *image.SignatureCondition, s conversion.Scope) error {
	...
	// WARNING: in.Status requires manual conversion: inconvertible types (invalid type vs k8s.io/kubernetes/pkg/api.ConditionStatus)
...
func autoConvert_image_SignatureCondition_To_v1_SignatureCondition(in *image.SignatureCondition, out *SignatureCondition, s conversion.Scope) error {
	...
	// WARNING: in.Status requires manual conversion: inconvertible types (k8s.io/kubernetes/pkg/api.ConditionStatus vs invalid type)
	out.LastProbeTime = in.LastProbeTime
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
	out.Message = in.Message
