...
func (this *BrokerTemplateInstanceSpec) String() string {
	...
	s := strings.Join([]string{`&BrokerTemplateInstanceSpec{`,
		`TemplateInstance:` + strings.Replace(strings.Replace(this.TemplateInstance.String(), "ObjectReference", "github_com_openshift_origin_pkg_authorization_apis_authorization_v1.ObjectReference", 1), `&`, ``, 1) + `,`,
		`Secret:` + strings.Replace(strings.Replace(this.Secret.String(), "ObjectReference", "github_com_openshift_origin_pkg_authorization_apis_authorization_v1.ObjectReference", 1), `&`, ``, 1) + `,`,
...
func (this *TemplateInstanceObject) String() string {
	...
	s := strings.Join([]string{`&TemplateInstanceObject{`,
		`Ref:` + strings.Replace(strings.Replace(this.Ref.String(), "ObjectReference", "github_com_openshift_origin_pkg_authorization_apis_authorization_v1.ObjectReference", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TemplateInstanceSpec) String() string {
	...
	s := strings.Join([]string{`&TemplateInstanceSpec{`,
		...
		`Secret:` + strings.Replace(fmt.Sprintf("%v", this.Secret), "LocalObjectReference", "github_com_openshift_origin_pkg_build_apis_build_v1.LocalObjectReference", 1) + `,`,
...
func (m *TemplateInstanceSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Secret == nil {
				m.Secret = &github_com_openshift_origin_pkg_build_apis_build_v1.LocalObjectReference{}
			}
			if err := m.Secret.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorGenerated = []byte{
	...
	,
}
