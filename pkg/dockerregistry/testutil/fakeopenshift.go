...
func (fos *FakeOpenShift) CreateImageStream(namespace string, is *imageapi.ImageStream) (*imageapi.ImageStream, error) {
	...
	is.CreationTimestamp = unversioned.Now()
...
func (fos *FakeOpenShift) getName(action core.Action) string {
...
func (fos *FakeOpenShift) todo(action core.Action) (bool, runtime.Object, error) {
	return true, nil, fmt.Errorf("no reaction implemented for %v", action)
}

func (fos *FakeOpenShift) imagesHandler(action core.Action) (bool, runtime.Object, error) {
	return fos.log(
...
func (fos *FakeOpenShift) imageStreamsHandler(action core.Action) (bool, runtime.Object, error) {
	return fos.log(
...
func (fos *FakeOpenShift) imageStreamMappingsHandler(action core.Action) (bool, runtime.Object, error) {
	return fos.log(
...
func (fos *FakeOpenShift) imageStreamImagesHandler(action core.Action) (bool, runtime.Object, error) {
	return fos.log(
