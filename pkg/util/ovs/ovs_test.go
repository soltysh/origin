...
func addTestResult(t *testing.T, fexec *exec.FakeExec, command string, output string, err error) *exec.FakeCmd {
	fcmd := &exec.FakeCmd{
...
func ensureInputFlows(t *testing.T, fakeCmd *exec.FakeCmd, flows []string) {
