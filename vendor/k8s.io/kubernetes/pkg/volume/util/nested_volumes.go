...
func getNestedMountpoints(name, baseDir string, pod api.Pod) ([]string, error) {
	var retval []string
	checkContainer := func(container *api.Container) error {
...
func MakeNestedMountpoints(name, baseDir string, pod api.Pod) error {
