...
angular.module('openshiftConsole')
  ...
  .filter('helpLink', function() {
    return function(type) {
      switch(type) {
        case "cli":
          return "https://docs.openshift.com/enterprise/3.1/cli_reference/overview.html";
        case "get_started_cli":
          return "https://docs.openshift.com/enterprise/3.1/cli_reference/get_started_cli.html";
        case "basic_cli_operations":
          return "https://docs.openshift.com/enterprise/3.1/cli_reference/basic_cli_operations.html";
        case "webhooks":
          return "http://docs.openshift.com/enterprise/3.1/dev_guide/builds.html#webhook-triggers";
        case "new_app":
          return "http://docs.openshift.com/enterprise/3.1/dev_guide/new_app.html";
        case "start-build":
